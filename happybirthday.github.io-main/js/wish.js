document.addEventListener("DOMContentLoaded", () => {
  ...
  const wishPrompts = (typeof BirthdayConfig !== "undefined" && BirthdayConfig.wishPrompts)
    ? BirthdayConfig.wishPrompts
    : ["Before we finish...", "When you're ready...", "Close your eyes.", "Make a wish."];
