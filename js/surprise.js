document.addEventListener("DOMContentLoaded", () => {
  ...
  function createFloatingMemories() {
    ...
    memoriesData.forEach((memory, index) => {
      ...
      ? `<video class="photo-img" src="${memory.photo}" muted autoplay loop playsinline webkit-playsinline preload="auto" style="width: 100%; aspect-ratio: 1; object-fit: cover; display: block;"></video>`
