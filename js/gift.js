document.addEventListener("DOMContentLoaded", () => {
  ...
  // 1. Use the chosen secret box from the configuration (with a random fallback).
  const configuredIndex = typeof BirthdayConfig !== "undefined"
    ? Number(BirthdayConfig.correctGiftIndex)
    : NaN;
  const correctIndex = Number.isInteger(configuredIndex) && configuredIndex >= 0 && configuredIndex < 5
    ? configuredIndex
  ...
  function createGiftBox(index) {
    ...
    button.addEventListener("click", () => {
      ...
      if (index === correctIndex) {
        ...
        huntMessage.innerHTML = `You found it! <span style="color: #ff527c; display: inline-flex; align-items: center; vertical-align: middle; margin-left: 0.35rem; margin-top: -0.25rem;"><svg viewBox="0 0 24 24" fill="currentColor" style="width: 1.4rem; height: 1.4rem;"><path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"/></svg></span>`;
